...
from ..validation.engine import validate_ticket_priority, validate_ticket_transition
...
class ServiceImmediatelyConnector:
        ...
        self._incidents: Dict[str, Dict[str, Any]] = {
            "INC0094821": {
                ...
                "comments": [
                    {
                        "author": "System",
                        "text": "Ticket routed to Network Tier 2",
                        "time": "2026-09-01T09:05:00Z",
                    },
                    {
                        "author": "Alex Chen",
                        "text": "Investigating Singapore Gateway logs",
    ...
    def update_status(
        self, ticket_id: str, target_status: str, resolution_notes: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        if resolution_notes:
            self.add_comment(
                ticket_id, "System", f"Status changed to {target_status}: {resolution_notes}"
            )
