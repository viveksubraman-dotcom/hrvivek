...
def execute_medical_leave_saga(employee_id: str, start_date: str, days: int = 10) -> Dict[str, Any]:
    ...
    leave_res = ww.submit_leave_request(employee_id, "Sick", start_date, end_str, requested_days=days)
...
def execute_relocation_saga(employee_id: str, new_address: str = "10 Baker St, London, UK", simulate_step3_failure: bool = False) -> Dict[str, Any]:
    ...
    if simulate_step3_failure:
        ...
        saga.log_step(saga_id, "COMPENSATING_ROLLBACK", "WorkWeek_HCM", rollback_res, status="ROLLBACK_SUCCESS")
