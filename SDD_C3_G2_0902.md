...
| Policy Hallucination / Fact Invention | Quality | High | Low | **OKF Tri-Hybrid Brain** + strict similarity thresholding (>=0.78) + deterministic rule validation prevents 100% of entitlement hallucinations. |
