...
def test_evalset_schema_and_tiers():
    ...
    assert tier_counts.get("Tier 1") == 18, f"Tier 1 expected 18 cases, got {tier_counts.get("Tier 1")}"
    assert tier_counts.get("Tier 2") == 13, f"Tier 2 expected 13 cases, got {tier_counts.get("Tier 2")}"
    assert tier_counts.get("Tier 3") == 6, f"Tier 3 expected 6 cases, got {tier_counts.get("Tier 3")}"
    assert tier_counts.get("Tier 4") == 6, f"Tier 4 expected 6 cases, got {tier_counts.get("Tier 4")}"
